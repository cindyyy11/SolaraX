...
@media (max-width: 900px) { .twin__workspace { grid-template-columns: 1fr; } .scene-shell { border-right: 0; border-bottom: 1px solid rgba(255,255,255,.09); } .scene-viewport { min-height: 390px; } .incident__steps { display: grid; grid-template-columns: repeat(2, 1fr); gap: .5rem; } .incident__steps li::after { display: none; } }
...
@media (prefers-reduced-motion: reduce) { .world { transition: none; } .drone--flying { animation: none; left: 56%; top: 50%; } }
</style>
